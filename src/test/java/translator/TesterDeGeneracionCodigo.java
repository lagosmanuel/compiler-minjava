...
public class TesterDeGeneracionCodigo {

    private static final String msgExito = "[SinErrores]";
    private static final String testFilesDirectoryPath = "resources/test-cases/codegen/sinErrores/";
    ...
    public TesterDeGeneracionCodigo(String input){
        this.input = input;
    }
    ...
    void probarExito(String name){
        ...
        String result ="";
        try {
            Process proc = Runtime.getRuntime().exec("java -jar VM.jar " + generatedFileName);
