...
public class SemanticErrorMessages {
    public static final String CLASS_REDECLARATION = "Class is already declared";
    public static final String CLASS_NOT_DECLARED = "Class is not declared";
    public static final String PARAMETER_REDECLARATION = "Parameter is already declared";
    public static final String METHOD_ALREADY_DEFINED = "Method is already defined";
    public static final String CONSTRUCTOR_ALREADY_DEFINED = "Constructor is already defined";
    ...
    public static final String TYPE_NOTFOUND = "Type not found";
